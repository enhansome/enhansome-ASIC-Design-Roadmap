...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,242 | 🐛 277 | 🌐 Scala | 📅 2026-09-08 📍![stars](https://img.shields.io/github/stars/OpenXiangShan/XiangShan) - Open-source high-performance RISC-V processor.

* [RISC-V Instruction Set Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,810 | 🐛 178 | 🌐 TeX | 📅 2026-09-08 - This repository contains the LaTeX source for the draft RISC-V Instruction Set Manual.
...
* [CVA6 RISC-V CPU](https://github.com/openhwgroup/cva6) ⭐ 3,096 | 🐛 263 | 🌐 Assembly | 📅 2026-09-08 📍![stars](https://img.shields.io/github/stars/openhwgroup/cva6) - An application class 6-stage RISC-V CPU capable of booting Linux.
...
* [FPGA Tutorial](https://github.com/LeiWang1999/FPGA) ⭐ 5,693 | 🐛 2 | 📅 2022-05-15
...
* [Icarus Verilog](http://iverilog.icarus.com/) 📍[Github](https://github.com/steveicarus/iverilog) ⭐ 3,631 | 🐛 185 | 🌐 C++ | 📅 2026-09-08![stars](https://img.shields.io/github/stars/steveicarus/iverilog) - A Verilog simulation and synthesis tool.
* [OpenROAD](https://theopenroadproject.org/) 💬[Doc](https://openroad.readthedocs.io/en/latest/main/README.html) 📍[Github](https://github.com/The-OpenROAD-Project/OpenROAD) ⭐ 3,078 | 🐛 221 | 🌐 Verilog | 📅 2026-09-08![stars](https://img.shields.io/github/stars/The-OpenROAD-Project/OpenROAD) - An RTL-to-GDS Flow
