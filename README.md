...
* [Basic Verilog Modules](https://github.com/pConst/basic_verilog) ⭐ 2,013 | 🐛 0 | 🌐 Verilog | 📅 2026-03-12 📍 - Synthesizable Verilog modules
...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,202 | 🐛 270 | 🌐 Scala | 📅 2026-08-20 📍![stars](https://img.shields.io/github/stars/OpenXiangShan/XiangShan) - Open-source high-performance RISC-V processor.

* [RISC-V Instruction Set Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,767 | 🐛 180 | 🌐 TeX | 📅 2026-08-20 - This repository contains the LaTeX source for the draft RISC-V Instruction Set Manual.
...
* [openc910](https://github.com/T-head-Semi/openc910) ⭐ 1,465 | 🐛 53 | 🌐 Verilog | 📅 2024-06-28 📍![stars](https://img.shields.io/github/stars/T-head-Semi/openc910) - OpenXuantie C910 Core.
...
* [FPGA Tutorial](https://github.com/LeiWang1999/FPGA) ⭐ 5,637 | 🐛 2 | 📅 2022-05-15
...
* [Icarus Verilog](http://iverilog.icarus.com/) 📍[Github](https://github.com/steveicarus/iverilog) ⭐ 3,601 | 🐛 189 | 🌐 C++ | 📅 2026-08-17![stars](https://img.shields.io/github/stars/steveicarus/iverilog) - A Verilog simulation and synthesis tool.
